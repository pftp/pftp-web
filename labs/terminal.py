#Welcome to Lab 5! We are going to learn about the Terminal and for loops today. Hit the 'Next' button to get started.
...
print 'I am so h4x I can use the terminal like a G'
