...
# Now download <a href="/static/assignments/flask_tutorial.zip">flask_tutorial.zip</a> and unzip it into your home directory. When you enter flask_tutorial, you'll see a file named `app.py`, and 2 folders named `static` and `templates`. To run the server which will let you see the website, run `python app.py`. Now you can visit <a href="http://127.0.0.1:5000">127.0.0.1:5000</a> to see your web app in action. 127.0.0.1 is a special url that is for servers which are running locally on your own computer.
