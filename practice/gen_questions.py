import os
import json
def read_problem(parent_dir, problem_dir):
    problem_path = parent_dir + '/' + problem_dir
    ...
    return {'prompt': prompt, 'expected': expected, 'solution': solution, 'test': test, 'hint': hint, 'template_vars': template_vars, 'problem_dir': problem_dir}



""" load the problems """
problem_dirs = os.listdir('problems')
all_problem_info = []
for problem_dir in problem_dirs:
    all_problem_info.append(read_problem('problems', problem_dir))
