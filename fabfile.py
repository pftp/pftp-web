...
def generate_models():
  ...
  assignment1 = Assignment(name='Homework 1', description='Draw something using at least 3 shapes and 3 colors. Have fun with it!',  points=10, deadline=datetime(2013,9,16))
